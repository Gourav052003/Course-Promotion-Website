				...
				<div class="form-left">
					...
					<div class="form-row">
						<select name="education_level">
						    <option class="option" value="Course level">Education level</option>
					...
					<div class="form-row">
						<select name="currently_doing">
						    <option value="Qualification of instructor">Currently doing?</option>
					...
					<div class="form-row">
						<input type="text" name="studying_from" class="studying_from" id="studying_from" placeholder="School/Institution/College/University name" required>
					</div>
					<div class="form-group">
						<div class="form-row form-row-3">
							<input type="text" name="DOB" class="DOB" id="DOB" placeholder="DOB (YYYY-MM-DD)" required>
						</div>
